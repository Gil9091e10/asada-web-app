...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '32751cb7-9982-4d25-96ff-cbceb1c818bc' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('d78883ed-cd07-4a0a-a85f-8089b3575620');
      cy.get(`[data-cy="name"]`).should('have.value', 'd78883ed-cd07-4a0a-a85f-8089b3575620');
